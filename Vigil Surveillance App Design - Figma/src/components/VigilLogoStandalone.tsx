 ...
 *   - Background elements: #0a0a0a
 * 
 * Light Mode:
 *   - Primary Cyan: #0891b2 (darker, better contrast)
 *   - Text: #1e293b (dark slate)
 *   - Background elements: #f8fafc
 */
...
export function VigilLogo({ 
  ...
  const colors = {
    dark: {
      ...
      highlight: '#f8fafc',    // White for highlights
      scanLine: '#06b6d4'      // Cyan for scan effects
    },
    light: {
      primary: '#3b82f6',      // Light blue for better visibility
      text: '#0f172a',         // Dark slate for high contrast
      background: '#f8fafc',   // Off-white
      highlight: '#2563eb',    // Darker blue for highlights
      scanLine: '#3b82f6'      // Light blue for scan effects
    }
  };
  ...
  return (
    ...
    >
      ...
      <g transform="translate(15, 20)">
        ...
        <g opacity="0.4">
          <line x1="25" y1="20" x2="25" y2="12" stroke={currentColors.primary} strokeWidth="0.8"/>
          <line x1="25" y1="20" x2="31" y2="14" stroke={currentColors.primary} strokeWidth="0.8"/>
          <line x1="25" y1="20" x2="33" y2="20" stroke={currentColors.primary} strokeWidth="0.8"/>
          <line x1="25" y1="20" x2="31" y2="26" stroke={currentColors.primary} strokeWidth="0.8"/>
          <line x1="25" y1="20" x2="25" y2="28" stroke={currentColors.primary} strokeWidth="0.8"/>
          <line x1="25" y1="20" x2="19" y2="26" stroke={currentColors.primary} strokeWidth="0.8"/>
          <line x1="25" y1="20" x2="17" y2="20" stroke={currentColors.primary} strokeWidth="0.8"/>
          <line x1="25" y1="20" x2="19" y2="14" stroke={currentColors.primary} strokeWidth="0.8"/>
        </g>
        ...
        <g opacity="0.7">
          {/* Corner brackets */}
          <path d="M 10 12 L 10 10 L 12 10" stroke={currentColors.highlight} strokeWidth="1.5" strokeLinecap="round"/>
          <path d="M 40 10 L 38 10 L 38 12" stroke={currentColors.highlight} strokeWidth="1.5" strokeLinecap="round"/>
          <path d="M 10 28 L 10 30 L 12 30" stroke={currentColors.highlight} strokeWidth="1.5" strokeLinecap="round"/>
          <path d="M 40 30 L 38 30 L 38 28" stroke={currentColors.highlight} strokeWidth="1.5" strokeLinecap="round"/>
        </g>
      ...
      <g transform="translate(75, 18)">
        ...
        {/* I */}
        <rect x="35" y="0" width="7" height="40" fill={currentColors.text}/>
        
        {/* G - proper G shape with open top-right */}
        {/* Top horizontal bar (shorter - leaves opening on right) */}
        <rect x="52" y="0" width="14" height="7" fill={currentColors.text}/>
        {/* Left vertical bar (full height) */}
        <rect x="52" y="0" width="7" height="40" fill={currentColors.text}/>
        {/* Bottom horizontal bar (full width) */}
        <rect x="52" y="33" width="20" height="7" fill={currentColors.text}/>
        {/* Middle horizontal bar (G's inward bar) */}
        <rect x="62" y="18" width="10" height="7" fill={currentColors.text}/>
        {/* Right vertical bar (bottom half only) */}
        <rect x="65" y="18" width="7" height="22" fill={currentColors.text}/>
        
        {/* I */}
        <rect x="82" y="0" width="7" height="40" fill={currentColors.text}/>
        
        {/* L */}
        <rect x="99" y="0" width="7" height="40" fill={currentColors.text}/>
        <rect x="99" y="33" width="20" height="7" fill={currentColors.text}/>
      </g>
      
      {/* Status indicator dot - animated pulse */}
      <circle cx="228" cy="48" r="3" fill={currentColors.primary}>
        <animate
